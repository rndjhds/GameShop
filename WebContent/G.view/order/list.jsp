           ...
           <c:forEach var="g" items="${Goodss }">
            <div class="col-sm-6 col-lg-3 mb-2-6">
                <div class="card-wrapper mb-4">
                    ...
                    <div class="card-body">
                        <div>
                            <a href="${pageContext.request.contextPath }/order/detail?seq=${g.seq }"><i class="bg-white p-3 rounded-circle ti-shopping-cart font-weight-600"></i></a>
                        </div>
                    </div>
                </div>
                <div class="text-center">
                    <h3 class="h5 mb-2"><a href="${pageContext.request.contextPath }/order/detail?seq=${g.seq }" class="text-secondary">${g.product_name}</a></h3>
